/*
 * grunt-sri-hash
 * https://github.com/sparanoid/sri-hash
 *
...
module.exports = function(grunt) {
  ...
  grunt.registerMultiTask('sri_hash', 'Inline external resources into HTML', function() {
    ...
    this.files.forEach(function(filePair) {
      ...
      var styles_dom_sri_hash = doc.querySelectorAll('style[data-sri-hash]');
      if (styles_dom_sri_hash.length) {
        for (var i = 0; i < styles_dom_sri_hash.length; i++) {
          var style = styles_dom_sri_hash[i].textContent;
          if (!style) { return; }
          ...
          styles_dom_sri_hash[i].textContent = style;
        }
      }
